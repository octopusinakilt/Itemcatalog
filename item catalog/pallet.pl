...
#							"</i><br>";
					if ($case_hash->{$caseID}->{caseID} == $pallet_hash->{$palletID}->{caseID})
					{
						...
						<tr class='tblInfoDataRowHiLight' style='height:30px;'>
							...
							<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;' colspan=2>".
								"<input name='CaseLayer_$pallet_hash->{$palletID}->{palletID}' type='text' style='width:30px' ".
								"value='$pallet_hash->{$palletID}->{casesPerLayer}'> Casses/Layer</td>".
								"<input name='old_CaseLayer_$pallet_hash->{$palletID}->{palletID}' type='hidden' ".
								"value='$pallet_hash->{$palletID}->{casesPerLayer}'> Casses/Layer</td>
							<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>&nbsp;</td>
							<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;' colspan=2>".
								"<input name='layerPallet_$pallet_hash->{$palletID}->{palletID}' type='text' style='width:30px' ".
								"value='$pallet_hash->{$palletID}->{layersPerPallet}'> Layers/Pallet</td>".
								"<input name='old_layerPallet_$pallet_hash->{$palletID}->{palletID}' type='hidden' ".
								"value='$pallet_hash->{$palletID}->{layersPerPallet}'> Layers/Pallet</td>
			...
			print "
				<tr class='tblInfoDataRowHiLight' style='height:30px;'>
					<td class='tblInfoDataFirst' colspan='2' style='width: 250px;border-bottom: 0px;border-right: 0px;'>&nbsp;</td>
					<td class='tblInfoData' style='width: 100px;text-align:right;border-bottom: 0px;border-right: 0px;'><b>New Pallet:</b></td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>&nbsp;</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;' colspan=2>".
						"<input name='newCaseLayer_$case_hash->{$caseID}->{caseID}' type='text' style='width:30px'> Casses/Layer</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>&nbsp;</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;' colspan=2>"
						."<input name='newLayerPallet_$case_hash->{$caseID}->{caseID}' type='text' style='width:30px'> Layers/Pallet</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;'>&nbsp;</td>
				</tr>";
			}
		}
				...
				foreach $palletID (keys (%{$pallet_hash}))
				{
					if ($case_hash->{$caseID}->{caseID} == $pallet_hash->{$palletID}->{caseID})
					{
						...
						<tr class='tblInfoDataRowHiLight' style='height:30px;'>
							...
							<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>$pallet_hash->{$palletID}->{GTIN}</td>
							<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;' colspan=2>".
								"<input name='old_CaseLayer_$pallet_hash->{$palletID}->{palletID}' type='hidden' value='$pallet_hash->{$palletID}->{casesPerLayer}'>".
								"<input name='CaseLayer_$pallet_hash->{$palletID}->{palletID}' type='text' style='width:30px' ".
								"value='$pallet_hash->{$palletID}->{casesPerLayer}'> Casses/Layer</td>
							<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>&nbsp;</td>
							<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;' colspan=2>".
								"<input name='old layerPallet_$pallet_hash->{$palletID}->{palletID}' type='hidden' value='$pallet_hash->{$palletID}->{layersPerPallet}'>".
								"<input name='layerPallet_$pallet_hash->{$palletID}->{palletID}' type='text' style='width:30px' ".
								"value='$pallet_hash->{$palletID}->{layersPerPallet}'> Layers/Pallet</td>
							<td class='tblInfoData' style='text-align:center;border-bottom: 0px;'>&nbsp;</td>
						</tr>";
...
print " 
  <div id='content'> <form name='Pallet_Data' action='/cgi-bin/itemcat/pallet_submit.pl' method='post'>
  <table class='formTable' style='width:900'>
      <tr>
