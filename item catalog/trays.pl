	...
	print "                                                                                                                               
		<tr class='tblInfoDataRowLight' onmouseover='className=\"tblInfoDataRowHiLight\"' onmouseout='className=\"tblInfoDataRowLight\"'> 
			...
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='pack_$tray->{trayID}' type='text' style='width:45px' value='$tray->{pack}'>
				<input name='old_pack_$tray->{trayID}' type='hidden' value='$tray->{pack}'>
				</td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='weight_$tray->{trayID}' type='text' style='width:40px' value='$tray->{weight}'> 
				<input name='old_weight_$tray->{trayID}' type='hidden' value='$tray->{weight}'> 
				
				
				<select name='weightUOM_$tray->{trayID}' style='width:45px'>";
				if ($tray->{weightUOM} eq 'oz')
					{
						print "<option value='oz' selected>oz</option>
					   	<option value='lbs'>lbs</option></select>";
					}
					else{
						print "<option value='oz'>oz</option>
					   	<option value='lbs' selected>lbs</option></select>";
					}
	print "		<input name='old_weightUOM_$tray->{trayID}' type='hidden' value='$tray->{weightUOM}'> 
				</td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='length_$tray->{trayID}' type='text' style='width:45px' value='$tray->{length}'>
				<input name='old_length_$tray->{trayID}' type='hidden' value='$tray->{length}'>
				</td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='height_$tray->{trayID}' type='text' style='width:45px' value='$tray->{height}'>
				<input name='old_height_$tray->{trayID}' type='hidden' value='$tray->{height}'>
				</td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='width_$tray->{trayID}' type='text' style='width:45px' value='$tray->{width}'>
				<input name='old_width_$tray->{trayID}' type='hidden' value='$tray->{width}'>
				</td>
...
#			print "CASE: $tray->{trayID} == $case_hash->{$i}->{trayID}, i=$i<br>";
			if ($tray->{trayID} == $case_hash->{$caseID}->{trayID})
			{
				...
				<tr class='tblInfoDataRowLight' onmouseover='className=\"tblInfoDataRowHiLight\"' onmouseout='className=\"tblInfoDataRowLight\"'> 
					...
					<td class='tblInfoData' colspan='2' style='width: 250px;border-bottom: 0px;border-right: 0px;'><b>Case:</b>".
						" $case_hash->{$caseID}->{caseUPC}</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>$case_hash->{$caseID}->{GTIN}</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>$case_hash->{$caseID}->{pack}</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>$case_hash->{$caseID}->{weight} ".
						"$case_hash->{$caseID}->{weightUOM}</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>$case_hash->{$caseID}->{length}</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>$case_hash->{$caseID}->{height}</td>
					<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>$case_hash->{$caseID}->{width}</td>
...
sub display_pallets_without_trays() {
	...
	print "<tr> 
	    ...
	    <td class='tblInfoCol' style='text-align:center;width:100px;border-right: 0px;'>UPC</td>
	    <td class='tblInfoCol' style='text-align:center;width:100px;'>&nbsp;</td>
	    <td class='tblInfoCol' style='text-align:center;width:250px;'>&nbsp;</td>
	    <td class='tblInfoCol' style='text-align:center;width:50px;'>Pack</td>
	    <td class='tblInfoCol' style='text-align:center;width:100px;'>Weight</td>
	    <td class='tblInfoCol' style='text-align:center;width:50px;'>Length</td>
	    <td class='tblInfoCol' style='text-align:center;width:50px;'>Height</td>
	    <td class='tblInfoCol' style='text-align:center;width:50px;'>Width</td>
	    <td class='tblInfoCol' style='text-align:center;width:50px;'></td>
  	</tr>";
  	...
  	print "                                                                                                                               
		<tr class='tblInfoDataRowLight' onmouseover='className=\"tblInfoDataRowHiLight\"' onmouseout='className=\"tblInfoDataRowLight\"'> 
			...
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'></td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='pack_NewTray' type='text' style='width:45px' value=''></td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='weight_NewTray' type='text' style='width:40px' value=''> 
				
				
				<select name='weightUOM_newTray' style='width:45px'>
					<option value='oz' selected>oz</option>
					<option value='lbs'>lbs</option>
				</select>
				</td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='length_NewTray' type='text' style='width:45px' value=''></td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='height_NewTray' type='text' style='width:45px' value=''></td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;border-right: 0px;'>
				<input name='width_NewTray' type='text' style='width:45px' value=''></td>
			<td class='tblInfoData' style='text-align:center;border-bottom: 0px;'></td>
		</tr>\n";
...
print " 
  <div id='content'> <form name='Pallet_Data' action='/cgi-bin/itemcat/tray_submit.pl' method='post'>
  <table class='formTable' style='width:900'>
      <tr>
